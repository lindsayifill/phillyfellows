...
jQuery(document).ready(function($){
	...
	function dslc_tut_prevent( dslc_event, dslc_allow ) {
		...
		//console.log( dslc_event );
		//console.log( dslc_allow );
	...
	function dslc_tut_proceed() {
		...
		/**
		 * Do NOT let them do stuff they should not
		 */

		// Stop all events on all element
		/*$(document).on('mousedown mouseup click', 'a, span, div', function(e){
			dslc_tut_prevent( e, '.dslc-tut-proceed' );
		});*/
		//$('*').off('mousedown mouseup click mouseenter mouseleave', false);
		//$('a:not("' + dslcStep.dslc_event_el + '")').on('mousedown mouseup click mouseenter mouseleave', false);

		// Alow events on specific elements
		//$('.dslc-tut-proceed').off( 'mousedown mouseup click', false );

		// Allow events on elements specific to the step
		//$( dslcStep.dslc_allow_events_el ).on( dslcStep.dslc_allow_events );
	...
	dslcTuts['502'] = [

		{
			...
			+ '</div>'
			+ '<a href="#" class="dslc-tut-proceed">START TUTORIAL<span class="dslc-tut-icon dslc-icon-chevron-right"></span></a>',
			'dslc_target' : 'body',
		...
		{
			'dslc_type' : 'action',
			'dslc_label' : 'First of all, let\'s <strong style="color: #54c13f;">activate</strong> the <strong style="color: #06b2ac;">Live Composer</strong>.',
			'dslc_target' : '.dslca-activate-composer-hook',
			'dslc_event_el' : '.dslca-activate-composer-hook',
	...
	dslcTuts['495'] = [
		...
		},
		{
			...
			'dslc_event_el' : '.dslca-modules-section-edit-option[data-id="bg_color"] input',
		...
		},
		{
			'dslc_type' : 'action',
			'dslc_label' : 'First, let\'s change the <strong>background color</strong>, choose any color and <a class="dslc-tut-proceed-2" href="#"><strong>click here to continue</strong></a> once you are done.',
			'dslc_target' : '.colorpicker:visible',
		...
		},
		{
			...
			+ '</div>'
			+ '<a href="http://livecomposerplugin.com/sandbox/tutorial-chapter-two/?dslc=active&dslc_tut=start" class="dslc-tut-proceed dslca-link">start chapter two<span class="dslc-tut-icon dslc-icon-chevron-right"></span></a>',
			'dslc_target' : 'body',
			'dslc_event_el' : '.dslc-tut-proceed',
			'dslc_event' : 'click.dslc_tut_modules_info',
			'dslc_animation' : 'fade',
	...
	dslcTuts['497'] = [
		...
		},
		{
			...
			+ '</div>'
			+ '<a href="http://livecomposerplugin.com/sandbox/tutorial-chapter-three/?dslc=active&dslc_tut=start" class="dslc-tut-proceed dslca-link">start chapter Three<span class="dslc-tut-icon dslc-icon-chevron-right"></span></a>',
			'dslc_target' : 'body',
			'dslc_event_el' : '.dslc-tut-proceed',
			'dslc_event' : 'click.dslc_tut_modules_info',
			'dslc_animation' : 'fade',
	...
	dslcTuts['500'] = [
		...
		},
		{
			...
			+ '<div class="dslc-tut-bubble-content">'
				...
				+ '<br>Before going on to the next step, you can take a look at some videos on how <strong style="color: #58bce5;">modules</strong> can be edited. Simply click on the launch video button below.'
				+ '<br>Once you are ready to continue, click to start chapter four, you will learn how to use the <strong style="color: #d8827d;">templates system</strong>.'
			+ '</div>'
			+ '<a href="http://livecomposerplugin.com/sandbox/tutorial-chapter-four/?dslc=active&dslc_tut=start" class="dslc-tut-proceed-secondary dslca-link">launch videos<span class="dslc-tut-icon dslc-icon-rocket"></span></a>'
			+ '<a href="http://livecomposerplugin.com/sandbox/tutorial-chapter-four/?dslc=active&dslc_tut=start" class="dslc-tut-proceed dslca-link">start chapter four<span class="dslc-tut-icon dslc-icon-chevron-right"></span></a>',
			'dslc_target' : 'body',
			'dslc_event_el' : '.dslc-tut-proceed',
			'dslc_event' : 'click.dslc_tut_modules_info',
			'dslc_animation' : 'fade',
	...
	dslcTuts['504'] = [
		...
		{
			'dslc_type' : 'action',
			'dslc_label' : 'Click <strong>Chapter Four</strong> to load the <strong>template</strong>.',
			'dslc_target' : '.dslca-template[data-id="chapter-four"]',
			'dslc_event_el' : '.dslca-template[data-id="chapter-four"]',
			'dslc_event' : 'click.dslc_tut_modules_info',
			'dslc_animation' : 'fade',
			'dslc_parent_el' : '.dslca-container',
			'dslc_pos' : 'above',
		...
		},
		{
			...
			'dslc_target' : '.dslc-modules-area.dslc-3-col',
			'dslc_event_el' : '.dslc-modules-area.dslc-3-col',
			'dslc_event' : 'mouseenter.dslc_tut_modules_info',
			'dslc_parent_el' : '.dslc-modules-area.dslc-3-col',
			'dslc_animation' : 'fade',
			'dslc_pos' : 'above',
			'dslc_func_start' : function() {
		...
		},
		{
			'dslc_type' : 'action',
			'dslc_label' : 'Let\'s move this <strong style="color: #5890e5;">modules area</strong> on the right of the blog.',
			'dslc_target' : '.dslc-modules-area.dslc-3-col .dslca-move-modules-area-hook',
			'dslc_event_el' : '.dslc-modules-area.dslc-3-col .dslca-move-modules-area-hook',
		...
		},
		{
			...
			+ '<div class="dslc-tut-bubble-content">'
				...
				+ '<br>Of course, we couldn\'t cover everything you can do with <strong style="color: #06b2ac;">Live Composer</strong>. Our goal was to show you how easy it is to work with it.'
				+ '<br>Now you can go play around with the plugin in our sandbox mode or look at some videos showing how the plugin works in more details.'
			+ '</div>'
			+ '<a href="http://livecomposerplugin.com/sandbox/tutorial-chapter-four/?dslc=active" class="dslc-tut-proceed-secondary dslca-link">launch videos<span class="dslc-tut-icon dslc-icon-rocket"></span></a>'
			+ '<a href="http://livecomposerplugin.com/sandbox/" class="dslc-tut-proceed dslca-link">go to sandbox<span class="dslc-tut-icon dslc-icon-chevron-right"></span></a>',
			'dslc_target' : 'body',
			'dslc_event_el' : '.dslc-tut-proceed',
			'dslc_event' : 'click.dslc_tut_modules_info',
			'dslc_animation' : 'fade'
