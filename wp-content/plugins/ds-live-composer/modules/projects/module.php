	...
	function output( $options ) {
		 ...
		 */
				...
				?><div class="<?php echo $container_class; ?>"><?php
					...
					while ( $dslc_query->have_posts() ) : $dslc_query->the_post(); $count += $increment; $real_count++;
						...
						<div class="<?php echo $element_class . $columns_class . $extra_class; ?>" data-cats="<?php echo $project_cats_data; ?>">
							...
							<?php if ( $post_elements == 'all' || in_array( 'title', $post_elements ) || in_array( 'categories', $post_elements ) ) : ?>

								<div class="dslc-project-main">
			...
			<?php else :
				...
				if ( $dslc_is_admin ) :
					?><div class="dslc-notification dslc-red">You do not have any projects at the moment. Go to <strong>WP Admin &rarr; Projects</strong> to add some. <span class="dslca-refresh-module-hook dslc-icon dslc-icon-refresh"></span></span></div><?php
				endif;
