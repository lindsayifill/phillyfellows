...
class DSLC_Partners extends DSLC_Module {
	...
	var $module_id = 'DSLC_Partners';
	var $module_title = 'Partners';
	var $module_icon = 'th';
	...
	function output( $options ) {
		 ...
		 */
			...
			$container_class = 'dslc-posts dslc-partners dslc-clearfix ';
		 ...
		 */
					...
					while ( $dslc_query->have_posts() ) : $dslc_query->the_post(); $count += $increment; $real_count++;
						...
						<div class="<?php echo $element_class . $columns_class . $extra_class; ?>" data-cats="<?php echo $post_cats_data; ?>">
							...
							<?php if ( $post_elements == 'all' || in_array( 'thumbnail', $post_elements ) ) : ?>
								...
								<div class="dslc-partner-thumb dslca-post-thumb">
							...
							<?php if ( $post_elements == 'all' || in_array( 'title', $post_elements ) || in_array( 'excerpt', $post_elements ) ) : ?>

								<div class="dslc-partner-main">
			...
			<?php else :
				...
				if ( $dslc_is_admin ) :
					?><div class="dslc-notification dslc-red">You do not have any partners at the moment. Go to <strong>WP Admin &rarr; Partners</strong> to add some. <span class="dslca-refresh-module-hook dslc-icon dslc-icon-refresh"></span></span></div><?php
				endif;
