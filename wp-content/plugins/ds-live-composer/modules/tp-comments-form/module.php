			...
			?>
				...
				<div class="dslc-tp-comment-form">
					...
					<?php else : 
						...
						global $commenter;
						comment_form( array(
							'label_submit' => ___( 'SUBMIT YOUR COMMENT', 'dslc_string' ), 
							'cancel_reply_link' => 'cancel',
							'comment_notes_before' => '',
							'comment_notes_after' => '',
							'title_reply' => ___( 'Leave a Comment', 'dslc_string' ),
							'title_reply_to' => ___( 'Reply to %s.', 'dslc_string'),
							'comment_field' => '<div class="comment-form-comment"><textarea id="comment" name="comment" placeholder="' . ___( 'Comment', 'dslc_string' ) . '" aria-required="true"></textarea></div>',
							'fields' => apply_filters( 'comment_form_default_fields', array(
								'author' => '<div class="comment-form-name"><input id="author" name="author" type=text value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" placeholder="' . ___( 'Name', 'dslc_string' ) . ' *" aria-required="true" /></div>',
								'email' => '<div class="comment-form-email"><input id="email" name="email" type=text value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" placeholder="' . ___( 'Email', 'dslc_string' ) . ' *" aria-required="true" /></div>',
								'url' => '<div class="comment-form-website"><input id="url" name="url" type=text value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" placeholder="' . ___( 'Website', 'dslc_string' ) . '" /></div>' 
							)),
						), $post_id); 
